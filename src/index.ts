...
app.get("/api/authreq", (req: Request, res: Response) => {
	...
	// Hint: Der x-ms-client-principal-Header, auf den in der API-Funktion zugegriffen werden kann, enthält das claims-Array nicht.
	...
	res.json({ result: "OK", userId: clientPrincipal.userId });
});
